    ...
    <section className="relative bg-[#101323] py-0.5">
      ...
      <div className="relative z-40 h-max bg-gradient-to-b from-transparent to-[#101323] px-6 md:px-12 lg:px-16">
        ...
        <div className="relative z-50 mb-16">
          <div className="my-6 mt-8 flex w-full items-center justify-between">
            <p className="font-oddval text-xl tracking-wide text-white lg:text-[26px]">Cursuri intermediare:</p>
            <a href="/all-courses" className="mr-2 flex items-center gap-2">
              <p className="font-inter text-sm font-bold tracking-wide text-white lg:text-base">Vezi toate</p>
              <ArrowLongRightIcon className="size-5 text-white" />
            </a>
          </div>
          <div className="mb-16 grid grid-cols-1 gap-8 sm:grid-cols-1 md:mb-30 md:grid-cols-2 lg:grid-cols-3">
            {coursesIntermediary.map((card, index) => (
              <CoursesCard key={index} {...card} />
            ))}
          </div>
          <div className="my-4 flex w-full items-center justify-between">
            <p className="font-oddval text-xl tracking-wide text-white lg:text-[26px]">Cursuri cu credite:</p>
            <a href="/all-courses" className="mr-2 flex items-center gap-2">
              <p className="font-inter text-sm font-bold tracking-wide text-white lg:text-base">Vezi toate</p>
              <ArrowLongRightIcon className="size-5 text-white" />
            </a>
